...
func testBooleanObject(actual object.Object, expected any) error {
	res := actual.(*object.Boolean).Value
	if res != expected {
		return fmt.Errorf("object has wrong value. got=%t, want=%t", res, expected)
	}
	return nil
}
